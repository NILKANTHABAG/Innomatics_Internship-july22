...
def show_home_page():
    ...
    video_file = open(r'C:\Users\smart\OneDrive\Desktop\Heroku Diamond App Deployment\Project\giphy.mp4', 'rb')
    ...
    df = pd.read_csv(r"C:\Users\smart\OneDrive\Desktop\Heroku Diamond App Deployment\Project\diamonds.csv")
    st.dataframe(df)

    s_box= st.selectbox('Select',('Head','Tail',"carat",'cut',"color","clarity"))
